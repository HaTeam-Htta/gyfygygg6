...
local OrionLib = {
    ...
    Themes = {
        Default = {
            Main = Color3.fromRGB(34, 34, 34),      -- 主背景色（深灰）
            Second = Color3.fromRGB(45, 44, 45),     -- 次级背景色（稍浅的灰）
            Stroke = Color3.fromRGB(60, 60, 60),     -- 边框色（灰色）
            Divider = Color3.fromRGB(60, 60, 60),   -- 分割线颜色（灰色）
            Text = Color3.fromRGB(255, 255, 255),   -- 主要文字颜色（纯白）
            TextDark = Color3.fromRGB(200, 200, 200) -- 暗色文字（浅灰）
        }
    },
...
local MainWindow = AddThemeObject(SetChildren(SetProps(MakeElement("RoundFrame", Color3.fromRGB(255, 255, 255), 0, 10), {
    ...
    SetProps(MakeElement("Image", "rbxassetid://78892482588180"), { 
